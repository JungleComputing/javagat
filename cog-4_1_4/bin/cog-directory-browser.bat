...
:nocogpath
    ...
    if NOT EXIST %COG_INSTALL_PATH%\lib\cog-gridfaces-1.0.jar goto nocogpath15
    goto cogpath
...
:found2
    ...
    if NOT EXIST %COG_INSTALL_PATH%\lib\cog-gridfaces-1.0.jar goto nocogpath25
    goto cogpath
...
:cogpath
    ...
    java %COG_OPTS% org.globus.cog.gridface.impl.directorybrowser.DirectoryBrowserImplTest %*
