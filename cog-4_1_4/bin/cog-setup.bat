...
:nocogpath
    ...
    if NOT EXIST %COG_INSTALL_PATH%\lib\cog-setup-0.91.jar goto nocogpath15
    goto cogpath
...
:found2
    ...
    if NOT EXIST %COG_INSTALL_PATH%\lib\cog-setup-0.91.jar goto nocogpath25
    goto cogpath
...
:cogpath
    ...
    java %COG_OPTS% org.globus.cog.gui.setup.CoGSetup %*
