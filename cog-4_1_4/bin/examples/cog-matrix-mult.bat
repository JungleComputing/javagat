...
:nocogpath
    ...
    if NOT EXIST %COG_INSTALL_PATH%\lib\cog-gridshell-1.0.jar goto nocogpath15
    goto cogpath
...
:found3
    ...
    if NOT EXIST %COG_INSTALL_PATH%\lib\cog-gridshell-1.0.jar goto nocogpath25
    goto cogpath
...
:cogpath
    ...
    java %COG_OPTS% org.globus.cog.gridshell.tasks.examples.MatrixMultiplyImpl %*
