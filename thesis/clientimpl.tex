...
representation.}. \dashline{The only downside is that Base64 encoding has a
overhead of about 137\% of the original data length, plus 814 bytes for headers.
For more information about the JSON format, we refer to \cite{json-www}.
}
