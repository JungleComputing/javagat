...
class SteeringMaster extends Thread {
    ...
    public void run() {
        try {
            ...
            System.out
                .println("MASTER: Controls available for MY_STEERABLE_COMPONENT:");

            for (int i = 0; i < controls.size(); i++)
                System.out
                    .println(((SteeringControlDefinition) controls.get(i))
                        .toString());
            ...
            SteeringControlDefinition startDefinition = (SteeringControlDefinition) controls
                .get(0);
            SteeringControlDefinition stopDefinition = (SteeringControlDefinition) controls
                .get(1);
            SteeringControlDefinition setIntDefinition = (SteeringControlDefinition) controls
                .get(2);
            SteeringControlDefinition setDoubleDefinition = (SteeringControlDefinition) controls
                .get(3);
            ...
            System.out
                .println("MASTER: Sending command to start simulation at MY_STEERABLE_COMPONENT ...");
            sm.executeControl("MY_STEERABLE_COMPONENT", new SteeringControl(
            ...
            for (int i = 0; i < 10; i++) {
                ...
                System.out
                    .println("MASTER: Sending command MY_STEERED_INT_1 = " + i
                        + " to MY_STEERABLE_COMPONENT ...");
                sm.executeControl("MY_STEERABLE_COMPONENT",
                    new SteeringControl(setIntDefinition, actualParameters1));
                System.out.println("MASTER: Command successfully sent.");
                ...
                System.out
                    .println("MASTER: Sending command MY_STEERED_INT_2 = " + 2
                        * i + " to MY_STEERABLE_COMPONENT ...");
                sm.executeControl("MY_STEERABLE_COMPONENT",
                    new SteeringControl(setIntDefinition, actualParameters2));
                System.out.println("MASTER: Command successfully sent.");
                ...
                System.out
                    .println("MASTER: Sending command MY_STEERED_DOUBLE = "
                        + 10.0 / i + " to MY_STEERABLE_COMPONENT ...");
                sm
                    .executeControl("MY_STEERABLE_COMPONENT",
                        new SteeringControl(setDoubleDefinition,
                            actualParameters3));
                System.out.println("MASTER: Command successfully sent.");
            }
            ...
            System.out
                .println("MASTER: Sending command to stop simulation at MY_STEERABLE_COMPONENT ...");
            sm.executeControl("MY_STEERABLE_COMPONENT", new SteeringControl(
                stopDefinition, null));
            System.out.println("MASTER: Command successfully sent.");
