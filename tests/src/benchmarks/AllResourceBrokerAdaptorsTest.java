...
public class AllResourceBrokerAdaptorsTest {
    ...
    public static void main(String[] args) {
        ...
        for (String adaptor : adaptors) {
            if (adaptor.startsWith("local")) {
                results[i++] = new ResourceBrokerAdaptorTest().test(adaptor, "localhost");
            } else {
                results[i++] = new ResourceBrokerAdaptorTest().test(adaptor, host);
            }
        }
        try {
