...
\section{How to get and install GAT}
...
Wiht the user \texttt{anonymous} and an empty password.
...
The Unicore adaptor is part of the "contributed" adaptors, and these
adaptors need to be built separately by:
\begin{enumerate}
\item change into the directory \$GAT\_LOCATION/adaptors,
\item all ant -f build-with-contributed'
\end{enumerate}

This will install the Unicore adaptor in \$GAT\_LOCATION/lib/adaptors
