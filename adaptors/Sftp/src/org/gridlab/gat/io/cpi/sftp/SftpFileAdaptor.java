...
public class SftpFileAdaptor extends FileCpi {
    ...
    public SftpFileAdaptor(GATContext gatContext, URI location)
        ...
        USE_CLIENT_CACHING = gatContext.getPreferences().containsKey("caching");
    ...
    protected static SftpConnection openConnection(GATContext context,
        ...
        if (!USE_CLIENT_CACHING) {
            return doWorkcreateConnection(context, location);
        }
        ...
        if (c == null) {
            c = doWorkcreateConnection(context, location);
    ...
    protected static SftpConnection doWorkcreateConnection(GATContext context,
        ...
        SftpUserInfo info;
        try {
            info = SftpSecurityUtils.getSftpCredential(context, "sftp",
                    location, SSH_PORT);
    ...
    protected void copyToLocal(URI src, URI dest) throws GATInvocationException {
        ...
        try {
            ...
            if (!new java.io.File(destPath).getParentFile().exists()) {
                ...
                // exception
                if (!(gatContext.getPreferences().containsKey("file.create") && ((String) gatContext
                        .getPreferences().get("file.create"))
    ...
    protected void copyToRemote(URI src, URI dest)
        ...
        try {
            ...
            tmpCon = openConnection(gatContext, dest);
