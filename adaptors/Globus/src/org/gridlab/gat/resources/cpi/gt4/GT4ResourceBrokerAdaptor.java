...
public class GT4ResourceBrokerAdaptor extends ResourceBrokerCpi {
    ...
    public GT4ResourceBrokerAdaptor(GATContext gatContext, URI brokerURI)
    ...
    protected SecurityContext getSecurityContext(JobDescription jobDescription)
        ...
        try {
            cred = GlobusSecurityUtils.getGlobusCredential(gatContext,
                    "gt4gridftp", location, DEFAULT_GRIDFTP_PORT);
        } catch (Exception e) {
            throw new GATInvocationException(
    ...
    public Job submitJob(JobDescription description, MetricListener listener,
        ...
        Sandbox sandbox = new Sandbox(gatContext, description, host, null,
                true, true, true, true);
        GT4Job job = new GT4Job(gatContext, description, sandbox);
