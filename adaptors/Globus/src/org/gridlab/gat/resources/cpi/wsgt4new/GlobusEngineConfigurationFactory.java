 ...
 * @author Stefan Bozic
 */
public class GlobusEngineConfigurationFactory implements EngineConfigurationFactory {

	/**
	 * Factory method that creates a new instance of {@link EngineConfigurationFactory}.
	 * 
	 * @param param a factory parameter
	...
	public EngineConfiguration getClientEngineConfig() {
		String wsddPath = System.getProperty("gat.adaptor.path") + java.io.File.separator + "GlobusAdaptor"
