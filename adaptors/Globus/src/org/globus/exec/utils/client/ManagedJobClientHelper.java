...
/**
 * This class is extended by GAT to set the right client-config.wsdd for the globus axis client.
 */
...
//	}
        ...
        throws Exception
    {
    	...
    	//ManagedJobServiceAddressingLocator locator = new ManagedJobServiceAddressingLocator();
