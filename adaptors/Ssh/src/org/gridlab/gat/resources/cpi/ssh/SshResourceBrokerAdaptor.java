...
public class SshResourceBrokerAdaptor extends ResourceBrokerCpi {
	 ...
	 */
	public SshResourceBrokerAdaptor(GATContext gatContext, URI brokerURI)
			throws Exception {
	...
	public Job submitJob(JobDescription description, MetricListener listener,
		...
		try {
			...
			// create the sandbox
			Sandbox sandbox = new Sandbox(gatContext,  description,
					getAuthority(), null, true, false, false, false);
			// create the job object
			SshJob job = new SshJob(gatContext,  description,
					sandbox);
	...
	private SshUserInfo createSshUserInfo()
		...
		return SshSecurityUtils.getSshCredential(gatContext, "ssh", brokerURI,
				brokerURI.getPort(SSH_PORT));
	}
