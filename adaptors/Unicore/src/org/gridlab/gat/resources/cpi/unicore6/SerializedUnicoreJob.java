...
public class SerializedUnicoreJob extends SerializedJob {
	...
	public SerializedUnicoreJob(String classname, JobDescription jobDescription, Sandbox sandbox, String jobId,
			long submissiontime, long starttime, long stoptime, SoftwareDescription sd) {
	...
	/**
	 * The method String windowsPath extracts the full windows path of an URI. If it is no windows path, the path name
	 * retrieved by the getPath method of the class URI is returned.
	 * 
	 * @param uri
