 ...
 * Schema.
 * $Id: Excluding.java,v 1.1 2005/04/07 13:48:19 rob Exp $
 */
...
public class Excluding implements java.io.Serializable {
     ...
     * @param vExcludingItem
     */
    public void addExcludingItem(int index, grms_schema.ExcludingItem vExcludingItem)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     * @param vExcludingItem
     */
    public void setExcludingItem(int index, grms_schema.ExcludingItem vExcludingItem)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _items.size())) {
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (grms_schema.Excluding) Unmarshaller.unmarshal(grms_schema.Excluding.class, reader);
