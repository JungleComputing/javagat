 ...
 * Schema.
 * $Id: TimeSlotChoiceDescriptor.java,v 1.1 2005/04/07 13:48:19 rob Exp $
 */
 ...
 */
public class TimeSlotChoiceDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TimeSlotChoiceDescriptor() {
        ...
        //-- _slotEnd
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.exolab.castor.types.Time.class, "_slotEnd", "slotEnd", org.exolab.castor.xml.NodeType.Element);
        ...
        //-- _slotDuration
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.exolab.castor.types.Duration.class, "_slotDuration", "slotDuration", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    TimeSlotChoice target = (TimeSlotChoice) object;
                    target.setSlotDuration( (org.exolab.castor.types.Duration) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
