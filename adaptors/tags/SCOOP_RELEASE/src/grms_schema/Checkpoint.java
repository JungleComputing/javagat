 ...
 * Schema.
 * $Id: Checkpoint.java,v 1.6 2005/04/07 13:48:18 rob Exp $
 */
...
public class Checkpoint implements java.io.Serializable {
     ...
     * @param vCheckpointItem
     */
    public void addCheckpointItem(int index, grms_schema.CheckpointItem vCheckpointItem)
        throws java.lang.IndexOutOfBoundsException
    {
    ...
    public grms_schema.CheckpointItem[] getCheckpointItem()
    {
        ...
        for (int index = 0; index < size; index++) {
            mArray[index] = (grms_schema.CheckpointItem) _items.elementAt(index);
        }
        return mArray;
     ...
     * @param vCheckpointItem
     */
    public void setCheckpointItem(int index, grms_schema.CheckpointItem vCheckpointItem)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _items.size())) {
     ...
     */
    public void setCheckpointItem(grms_schema.CheckpointItem[] checkpointItemArray)
    {
        //-- copy array
        _items.removeAllElements();
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (grms_schema.Checkpoint) Unmarshaller.unmarshal(grms_schema.Checkpoint.class, reader);
