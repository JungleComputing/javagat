 ...
 * Schema.
 * $Id: BaseFileDescriptor.java,v 1.6 2005/04/07 13:48:18 rob Exp $
 */
 ...
 */
public class BaseFileDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public BaseFileDescriptor() {
        ...
        //-- _collectionfile
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(grms_schema.Collectionfile.class, "_collectionfile", "collectionfile", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    BaseFile target = (BaseFile) object;
                    target.setCollectionfile( (grms_schema.Collectionfile) value);
                }
