 ...
 * Schema.
 * $Id: BaseFileTypeType.java,v 1.6 2005/04/07 13:48:19 rob Exp $
 */
...
public class BaseFileTypeType implements java.io.Serializable {
     ...
     */
    public static final BaseFileTypeType IN = new BaseFileTypeType(IN_TYPE, "in");
     ...
     */
    public static final BaseFileTypeType OUT = new BaseFileTypeType(OUT_TYPE, "out");
     ...
     */
    public static final BaseFileTypeType INOUT = new BaseFileTypeType(INOUT_TYPE, "inout");
     ...
     */
    public static grms_schema.types.BaseFileTypeType valueOf(java.lang.String string)
    {
