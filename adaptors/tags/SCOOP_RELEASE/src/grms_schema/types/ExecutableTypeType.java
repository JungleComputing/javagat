 ...
 * Schema.
 * $Id: ExecutableTypeType.java,v 1.6 2005/04/07 13:48:19 rob Exp $
 */
...
public class ExecutableTypeType implements java.io.Serializable {
     ...
     */
    public static final ExecutableTypeType SINGLE = new ExecutableTypeType(SINGLE_TYPE, "single");
     ...
     */
    public static final ExecutableTypeType MULTIPLE = new ExecutableTypeType(MULTIPLE_TYPE, "multiple");
     ...
     */
    public static final ExecutableTypeType MPI = new ExecutableTypeType(MPI_TYPE, "mpi");
     ...
     */
    public static grms_schema.types.ExecutableTypeType valueOf(java.lang.String string)
    {
