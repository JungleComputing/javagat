 ...
 * Schema.
 * $Id: DirectoryTypeTypeType.java,v 1.6 2005/04/07 13:48:19 rob Exp $
 */
...
public class DirectoryTypeTypeType implements java.io.Serializable {
     ...
     */
    public static final DirectoryTypeTypeType IN = new DirectoryTypeTypeType(IN_TYPE, "in");
     ...
     */
    public static final DirectoryTypeTypeType OUT = new DirectoryTypeTypeType(OUT_TYPE, "out");
     ...
     */
    public static final DirectoryTypeTypeType INOUT = new DirectoryTypeTypeType(INOUT_TYPE, "inout");
     ...
     */
    public static grms_schema.types.DirectoryTypeTypeType valueOf(java.lang.String string)
    {
        java.lang.Object obj = null;
        if (string != null) obj = _memberTable.get(string);
        if (obj == null) {
            String err = "'" + string + "' is not a valid DirectoryTypeTypeType";
