 ...
 * Schema.
 * $Id: ExecutionTimeTypeDescriptor.java,v 1.1 2005/04/07 13:48:19 rob Exp $
 */
 ...
 */
public class ExecutionTimeTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ExecutionTimeTypeDescriptor() {
        ...
        //-- _timeSlot
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(grms_schema.TimeSlot.class, "_timeSlot", "timeSlot", org.exolab.castor.xml.NodeType.Element);
        ...
        //-- _execDuration
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.exolab.castor.types.Duration.class, "_execDuration", "execDuration", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ExecutionTimeType target = (ExecutionTimeType) object;
                    target.setExecDuration( (org.exolab.castor.types.Duration) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
        //-- _timePeriod
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(grms_schema.TimePeriod.class, "_timePeriod", "timePeriod", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
