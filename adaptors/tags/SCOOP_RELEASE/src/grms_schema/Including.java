 ...
 * Schema.
 * $Id: Including.java,v 1.1 2005/04/07 13:48:19 rob Exp $
 */
...
public class Including implements java.io.Serializable {
     ...
     * @param vIncludingItem
     */
    public void addIncludingItem(int index, grms_schema.IncludingItem vIncludingItem)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     * @param vIncludingItem
     */
    public void setIncludingItem(int index, grms_schema.IncludingItem vIncludingItem)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _items.size())) {
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (grms_schema.Including) Unmarshaller.unmarshal(grms_schema.Including.class, reader);
