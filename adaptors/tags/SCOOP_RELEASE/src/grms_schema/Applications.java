 ...
 * Schema.
 * $Id: Applications.java,v 1.1 2005/04/07 13:48:18 rob Exp $
 */
...
public class Applications implements java.io.Serializable {
    ...
    public grms_schema.Application[] getApplication()
    {
        ...
        for (int index = 0; index < size; index++) {
            mArray[index] = (grms_schema.Application) _applicationList.elementAt(index);
        }
        return mArray;
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (grms_schema.Applications) Unmarshaller.unmarshal(grms_schema.Applications.class, reader);
