 ...
 * Schema.
 * $Id: TimePeriodChoiceDescriptor.java,v 1.1 2005/04/07 13:48:19 rob Exp $
 */
 ...
 */
public class TimePeriodChoiceDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TimePeriodChoiceDescriptor() {
        ...
        //-- _periodEnd
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.util.Date.class, "_periodEnd", "periodEnd", org.exolab.castor.xml.NodeType.Element);
        ...
        //-- _periodDuration
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(org.exolab.castor.types.Duration.class, "_periodDuration", "periodDuration", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    TimePeriodChoice target = (TimePeriodChoice) object;
                    target.setPeriodDuration( (org.exolab.castor.types.Duration) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
