 ...
 * Schema.
 * $Id: SimplejobType.java,v 1.6 2005/04/07 13:48:19 rob Exp $
 */
...
public class SimplejobType implements java.io.Serializable {
    ...
    public grms_schema.Resource[] getResource()
    {
        ...
        for (int index = 0; index < size; index++) {
            mArray[index] = (grms_schema.Resource) _resourceList.elementAt(index);
        }
        return mArray;
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (grms_schema.SimplejobType) Unmarshaller.unmarshal(grms_schema.SimplejobType.class, reader);
