 ...
 *
 * @author Gábor Gombás
 * @version $Id: ControlProvider.java,v 1.1 2005/06/13 01:49:15 aagapi Exp $
 *
...
public interface ControlProvider {
	 ...
	 */
	public boolean checkControlArguments(ControlDefinition def, MonitorArg[] args);
	 ...
	 */
	public void executeControl(ControlDefinition def, MonitorArg[] args, MeasurementNotifier notifier);
}
