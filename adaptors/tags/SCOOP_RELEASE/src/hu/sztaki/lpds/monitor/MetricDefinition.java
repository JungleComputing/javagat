 ...
 *
 * @author Gábor Gombás
 * @version $Id: MetricDefinition.java,v 1.1 2005/06/13 01:48:47 aagapi Exp $
 *
...
public class MetricDefinition {
	 ...
	 *				{@link MeasurementType#EVENT}.
	 */
	public MetricDefinition(String name, MonitorType type, MeasurementType measurementType) {
		this.name = name;
		this.type = type;
		this.measurementType = measurementType;
	}
