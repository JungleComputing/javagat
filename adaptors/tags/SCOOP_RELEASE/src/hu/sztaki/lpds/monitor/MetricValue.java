 ...
 *
 * @author Gábor Gombás
 * @version $Id: MetricValue.java,v 1.1 2005/06/13 01:48:47 aagapi Exp $
 *
...
public class MetricValue {
	 ...
	 */
	public MetricValue(MonitorConsumer conn, int metricId, Object value, Date timestamp, MetricDefinition def) {
		this.conn = conn;
	...
	public int getKilledId() {
		if (metricId != MID_KILLED)
			throw new RuntimeMonitorException("This is not a MID_KILLED message.");
	...
	public int getDroppedId() {
		if (metricId != MID_DROPPED)
			throw new RuntimeMonitorException("This is not a MID_DROPPED message.");
		UnsignedInteger[] val = (UnsignedInteger[])value;
