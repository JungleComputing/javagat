 ...
 *
 * @author G??bor Gomb??s
 * @version $Id: AppMonitor.java,v 1.2 2005/06/22 09:55:03 rob Exp $
 *
...
public final class AppMonitor extends Thread {
	...
	static {
		...
		System.loadLibrary("mercury_consumer_java-" +
			Version.getVersion());
		System.loadLibrary("mercury_producer_java-" +
			Version.getVersion());
	 ...
	 *	failed.
	 */
	public AppMonitor(String appName, int tid, String jobId) throws MonitorException {
		if (monitor != null)
			throw new MonitorException("There may me one AppMonitor object only");
	 ...
	 *	but a control.
	 */
	public synchronized native void registerMetricProvider(MetricDefinition def, MetricProvider provider)
	 ...
	 */
	public synchronized native void registerControlProvider(ControlDefinition def, ControlProvider provider)
			throws MonitorException;
	 ...
	 */
	private synchronized native void nativeSendEvent(String name, MonitorArg[] args, byte[] value);
