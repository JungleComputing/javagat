...
public class IgridStub extends org.apache.axis.client.Stub implements
	...
	static {
		...
		oper
				.setReturnQName(new javax.xml.namespace.QName("urn:igrid",
						"result"));
		...
		oper.addParameter(new javax.xml.namespace.QName("urn:igrid", "load"),
				...
				float.class, org.apache.axis.description.ParameterDesc.IN,
				false, false);
		oper.setReturnType(new javax.xml.namespace.QName(
				"http://www.w3.org/2001/XMLSchema", "string"));
		oper.setReturnClass(java.lang.String.class);
	...
	public int updateWebservice(java.lang.String name,
			...
			java.lang.String url, int validityTime)
			throws java.rmi.RemoteException {
		if (super.cachedEndpoint == null) {
			throw new org.apache.axis.NoEndPointException();
		}
		...
		setAttachments(_call);
		java.lang.Object _resp = _call
				.invoke(new java.lang.Object[] { name, keywords, description,
						url, new java.lang.Integer(validityTime) });
	...
	public java.lang.String lookupService(java.lang.String name,
			java.lang.String hostname, int dport, int sport,
			java.lang.String prot) throws java.rmi.RemoteException {
		if (super.cachedEndpoint == null) {
			throw new org.apache.axis.NoEndPointException();
		}
		org.apache.axis.client.Call _call = createCall();
	...
	public java.lang.String lookupMemory(int totalRam, int totalSwap,
		...
		java.lang.Object _resp = _call
				.invoke(new java.lang.Object[] {
						new java.lang.Integer(totalRam),
						new java.lang.Integer(totalSwap),
						new java.lang.Integer(freeRam),
						new java.lang.Integer(freeSwap) });
	...
	public int registerVo(java.lang.String name, java.lang.String helpDeskPN,
		...
		setAttachments(_call);
		java.lang.Object _resp = _call.invoke(new java.lang.Object[] { name,
				helpDeskPN, restype, jobm, queue, fsPath, helpDeskURL,
				adminname, host, new java.lang.Integer(validityTime) });
