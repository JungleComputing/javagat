...
public class GlobusBrokerAdaptor extends ResourceBrokerCpi {
	public GlobusBrokerAdaptor(GATContext gatContext, Preferences preferences)
        ...
        if (!GATEngine.DEBUG) {
            Logger logger = Logger
                    .getLogger(NoAuthorization.class.getName());
	...
	String getResourceManagerContact(JobDescription description)
			throws GATInvocationException {
		String res = null;
		String jobManager = (String) preferences.get("ResourceBroker.jobmanager");
	...
	public Job submitJob(JobDescription description)
        ...
        GSSCredential credential = GlobusSecurityUtils.getGlobusCredential(gatContext, preferences, "gridftp", hostUri, ResourceManagerContact.DEFAULT_PORT);
