    ...
    private Vector listNoMinusD(FTPClient c, String filter)
        ...
        while ((line = reader.readLine()) != null) {
            ...
            try {
                ...
                System.err.println("globus file adaptor: WARNING, could not create FileInfo for: " + line);
/*
     ...
     */
    public String fixListReply(String reply) 
         throws FTPException {
        ...
        if(GATEngine.DEBUG) {
            System.err.println("fixing old ftp server list reply: " + reply + "#tokens = " + tokens.countTokens());
        }
      ...
      if(GATEngine.DEBUG) {
          System.err.println("COG workaround parsing old ftp server list reply.");
      }
