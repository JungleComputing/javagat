...
public class SocketEndpointAdaptor extends EndpointCpi implements Serializable {
	...
	public static Advertisable unmarshal(GATContext context, Preferences preferences, String s) {
		try {
			SocketEndpointAdaptor res = (SocketEndpointAdaptor) GATEngine.defaultUnmarshal 
			
			(SocketEndpointAdaptor.class, s);
