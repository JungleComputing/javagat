...
class GlobusContextCreator implements SecurityContextCreator {
    ...
    public SecurityContext createDefaultSecurityContext(GATContext gatContext, Preferences preferences, URI location)
    ...
    public Object createUserData(GATContext gatContext, Preferences preferences, URI location, SecurityContext inContext)
            throws GATInvocationException {
        ...
        if (inContext instanceof CertificateSecurityContext) {
            ...
            GSSCredential cred = GlobusSecurityUtils.getCredentialFromMyProxyServer(c.getHost(), c.getPort(),
...
public class GlobusSecurityUtils {
    ...
    public static GSSCredential getCredentialFromMyProxyServer(String host,
        ...
        try {
            ...
            throw new GATInvocationException("getCredentialFromMyProxyServer",
                    e);
        }
    }
}