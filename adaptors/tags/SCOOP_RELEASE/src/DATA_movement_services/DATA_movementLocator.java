...
public class DATA_movementLocator extends org.apache.axis.client.Service implements DATA_movement_services.DATA_movement {
    ...
    public DATA_movement_services.DATA_movementPortType getDATA_movement() throws javax.xml.rpc.ServiceException {
    ...
    public DATA_movement_services.DATA_movementPortType getDATA_movement(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            DATA_movement_services.DATA_movementStub _stub = new DATA_movement_services.DATA_movementStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (DATA_movement_services.DATA_movementPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                DATA_movement_services.DATA_movementStub _stub = new DATA_movement_services.DATA_movementStub(new java.net.URL(DATA_movement_address), this);
                _stub.setPortName(getDATA_movementWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:DATA_movement_services", "DATA_movement");
    }
