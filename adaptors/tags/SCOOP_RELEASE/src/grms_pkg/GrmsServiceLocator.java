...
public class GrmsServiceLocator extends org.apache.axis.client.Service implements grms_pkg.GrmsService {
...
//    private final java.lang.String grms_address = "httpg://rage1.man.poznan.pl:8543/axis/services/grms";
    ...
    public grms_pkg.Grms getgrms(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            grms_pkg.GrmsSoapBindingStub _stub = new grms_pkg.GrmsSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (grms_pkg.Grms.class.isAssignableFrom(serviceEndpointInterface)) {
                grms_pkg.GrmsSoapBindingStub _stub = new grms_pkg.GrmsSoapBindingStub(new java.net.URL(grms_address), this);
                _stub.setPortName(getgrmsWSDDServiceName());
                return _stub;
            }
        }
