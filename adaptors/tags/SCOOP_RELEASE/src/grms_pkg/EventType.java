...
public class EventType implements java.io.Serializable {
    ...
    public static final EventType STATUS = new EventType(_STATUS);
    public static final EventType REQUEST = new EventType(_REQUEST);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:grms", "EventType"));
    }
    /**
