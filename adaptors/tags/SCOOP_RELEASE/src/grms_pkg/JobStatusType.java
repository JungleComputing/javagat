...
public class JobStatusType implements java.io.Serializable {
    ...
    public static final JobStatusType PREPROCESSING = new JobStatusType(_PREPROCESSING);
    ...
    public static final JobStatusType POSTPROCESSING = new JobStatusType(_POSTPROCESSING);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:grms", "JobStatusType"));
    }
    /**
