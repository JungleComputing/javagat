...
public class ZibdmsLocator extends org.apache.axis.client.Service implements
        zibdms_pkg.Zibdms {
    ...
    public zibdms_pkg.ZibdmsPortType getzibdms()
    ...
    public zibdms_pkg.ZibdmsPortType getzibdms(java.net.URL portAddress)
        throws javax.xml.rpc.ServiceException {
        try {
            zibdms_pkg.ZibdmsStub _stub = new zibdms_pkg.ZibdmsStub(
                portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface)
        throws javax.xml.rpc.ServiceException {
        try {
            if (zibdms_pkg.ZibdmsPortType.class
                .isAssignableFrom(serviceEndpointInterface)) {
                zibdms_pkg.ZibdmsStub _stub = new zibdms_pkg.ZibdmsStub(
                    new java.net.URL(zibdms_address), this);
                _stub.setPortName(getzibdmsWSDDServiceName());
                return _stub;
            }
