 ...
 * @version $Id: MeasurementType.java,v 1.2 2005/10/07 11:05:55 rob Exp $
 *
...
public final class MeasurementType {
     ...
     */
    public static final MeasurementType CONTINUOUS = new MeasurementType(
        MON_CONTINUOUS);

    /**
     * Means that a measurement is triggered by some external event.
     */
    public static final MeasurementType EVENT = new MeasurementType(
        MON_EVENTLIKE);
    ...
    public String toString() {
        if (code == MON_CONTINUOUS) return "continuous";
        else return "event";
    }
}
