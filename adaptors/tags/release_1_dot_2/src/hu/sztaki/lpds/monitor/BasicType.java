 ...
 *
 * @author G??bor Gomb??s
 * @version $Id: BasicType.java,v 1.2 2005/10/07 11:05:55 rob Exp $
 *
...
public final class BasicType {
     ...
     */
    private static final String[] names = { "", "int32", "uint32", "int64",
        "uint64", "double", "boolean", "string", "opaque", "rec", "array",
        "void" };
