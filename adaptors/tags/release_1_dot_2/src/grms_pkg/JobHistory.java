...
public class JobHistory implements java.io.Serializable {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true
            ...
            && ((this.localSubmissionTime == null && other
                .getLocalSubmissionTime() == null) || (this.localSubmissionTime != null && this.localSubmissionTime
                .equals(other.getLocalSubmissionTime())))
            && ((this.localStartTime == null && other.getLocalStartTime() == null) || (this.localStartTime != null && this.localStartTime
                .equals(other.getLocalStartTime())))
            && ((this.localFinishTime == null && other.getLocalFinishTime() == null) || (this.localFinishTime != null && this.localFinishTime
                .equals(other.getLocalFinishTime())))
            && ((this.jobDescription == null && other.getJobDescription() == null) || (this.jobDescription != null && this.jobDescription
                .equals(other.getJobDescription())))
            && ((this.applicationAccess == null && other.getApplicationAccess() == null) || (this.applicationAccess != null && this.applicationAccess
                .equals(other.getApplicationAccess())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    static {
        ...
        elemField
            .setXmlName(new javax.xml.namespace.QName("", "localStartTime"));
        elemField.setXmlType(new javax.xml.namespace.QName(
            "http://www.w3.org/2001/XMLSchema", "dateTime"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField
            .setXmlName(new javax.xml.namespace.QName("", "jobDescription"));
        elemField.setXmlType(new javax.xml.namespace.QName(
            "http://www.w3.org/2001/XMLSchema", "string"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
