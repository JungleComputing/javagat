...
public class SocketEndpointAdaptor extends EndpointCpi implements Serializable {
	...
	public SocketEndpointAdaptor() throws AdaptorCreationException {
		super(null, null);
	}
	...
	public SocketEndpointAdaptor(GATContext gatContext, Preferences preferences)
		...
		try {
			...
			serverSocket = new ServerSocket(0, 0, localAddress); // bind to any free port
	...
	public static Advertisable unmarshal(String s) {
		...
		try {
			SocketEndpointAdaptor res = (SocketEndpointAdaptor) Unmarshaller.unmarshal(SocketEndpointAdaptor.class, sr);
	...
	public String toString() {
		return "endpoint: localPort = " + localPort + ", localAddr = " + localAddress +
		", remotePort = " + remotePort + ", remoteAddr = " + remoteAddress; 
	}
}