 ...
 * @author rob
 */
public class DefaultRandomAccessFileAdaptor extends RandomAccessFileCpi {

	RandomAccessFile rf;
	
	public DefaultRandomAccessFileAdaptor(GATContext gatContext,
			Preferences preferences, File file, String mode)  throws AdaptorCreationException {
