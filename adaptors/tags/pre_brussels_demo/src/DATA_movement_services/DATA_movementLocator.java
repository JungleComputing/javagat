...
public class DATA_movementLocator extends org.apache.axis.client.Service
	...
	private final java.lang.String DATA_movement_address = "httpg://litchi.zib.de:18090";
	...
	public DATA_movement_services.DATA_movementPortType getDATA_movement(
		...
		try {
			DATA_movement_services.DATA_movementBindingStub _stub = new DATA_movement_services.DATA_movementBindingStub(
					portAddress, this);
