...
public class PairOfStringBoolArray implements java.io.Serializable {
	private csrdms_pkg.PairOfStringBool[] item;

	public PairOfStringBoolArray() {
	}

	public csrdms_pkg.PairOfStringBool[] getItem() {
		return item;
	}

	public void setItem(csrdms_pkg.PairOfStringBool[] item) {
		this.item = item;
	}

	public csrdms_pkg.PairOfStringBool getItem(int i) {
		return item[i];
	}

	public void setItem(int i, csrdms_pkg.PairOfStringBool value) {
		this.item[i] = value;
	}
