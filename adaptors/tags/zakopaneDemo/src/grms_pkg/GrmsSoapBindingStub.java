...
public class GrmsSoapBindingStub extends org.apache.axis.client.Stub implements
	...
	static {
		...
		oper
				.addParameter(new javax.xml.namespace.QName("", "resources"),
						new javax.xml.namespace.QName("urn:grms",
								"ArrayOf_xsd_string"),
						java.lang.String[].class,
						org.apache.axis.description.ParameterDesc.OUT, false,
						false);
		...
		oper
				.addParameter(new javax.xml.namespace.QName("", "jobsList"),
						new javax.xml.namespace.QName("urn:grms",
								"ArrayOf_xsd_string"),
						java.lang.String[].class,
						org.apache.axis.description.ParameterDesc.OUT, false,
		...
		oper.addParameter(new javax.xml.namespace.QName("", "client"),
				new javax.xml.namespace.QName(
						"http://www.w3.org/2001/XMLSchema", "string"),
				java.lang.String.class,
				org.apache.axis.description.ParameterDesc.IN, false, false);
		oper
				.addParameter(new javax.xml.namespace.QName("", "request"),
						new javax.xml.namespace.QName("urn:grms",
								"NotificationRequest"),
						grms_pkg.NotificationRequest.class,
						org.apache.axis.description.ParameterDesc.IN, false,
						false);
		...
		oper.addParameter(new javax.xml.namespace.QName("", "items"),
				...
				org.apache.axis.description.ParameterDesc.IN, false, false);
		oper
				.addParameter(new javax.xml.namespace.QName("", "result"),
						new javax.xml.namespace.QName("urn:grms",
								"ArrayOfGrmsResponse"),
						...
						false);
		oper.addParameter(new javax.xml.namespace.QName("",
				"addOutFileDirsReturn"), new javax.xml.namespace.QName(
		...
		oper.setReturnClass(grms_pkg.GrmsResponse.class);
		oper.setReturnQName(new javax.xml.namespace.QName("",
				"getOutFileDirsReturn"));
		oper.setStyle(org.apache.axis.enum.Style.RPC);
		oper.setUse(org.apache.axis.enum.Use.ENCODED);
		_operations[20] = oper;

		oper = new org.apache.axis.description.OperationDesc();
		oper.setName("deleteOutFileDirs");
		oper.addParameter(new javax.xml.namespace.QName("", "jobId"),
				new javax.xml.namespace.QName(
						"http://www.w3.org/2001/XMLSchema", "string"),
				java.lang.String.class,
		...
		oper
				.addParameter(new javax.xml.namespace.QName("", "result"),
						...
						false);
		oper.addParameter(new javax.xml.namespace.QName("",
				"deleteOutFileDirsReturn"), new javax.xml.namespace.QName(
				"urn:grms", "GrmsResponse"), grms_pkg.GrmsResponse.class,
				org.apache.axis.description.ParameterDesc.OUT, false, false);
		oper.addParameter(new javax.xml.namespace.QName("", "errors"),
				new javax.xml.namespace.QName(
		...
		oper.addParameter(new javax.xml.namespace.QName("",
				...
				new javax.xml.namespace.QName("urn:grms", "GrmsResponse"),
				grms_pkg.GrmsResponse.class,
				org.apache.axis.description.ParameterDesc.OUT, false, false);
		oper.addParameter(new javax.xml.namespace.QName("", "errors"),
				new javax.xml.namespace.QName(
	...
	public GrmsSoapBindingStub(javax.xml.rpc.Service service)
		...
		qName = new javax.xml.namespace.QName("urn:grms", "NotificationType");
		cachedSerQNames.add(qName);
		cls = grms_pkg.NotificationType.class;
		cachedSerClasses.add(cls);
	...
	public grms_pkg.GrmsResponse unregisterNotification(
		...
		setAttachments(_call);
		java.lang.Object _resp = _call
				.invoke(new java.lang.Object[] { notificationId });
	...
	public void addOutFileDirs(java.lang.String jobId,
		...
		if (_resp instanceof java.rmi.RemoteException) {
			...
			try {
				addOutFileDirsReturn.value = (grms_pkg.GrmsResponse) _output
						.get(new javax.xml.namespace.QName("",
								"addOutFileDirsReturn"));
			} catch (java.lang.Exception _exception) {
				addOutFileDirsReturn.value = (grms_pkg.GrmsResponse) org.apache.axis.utils.JavaUtils
						.convert(_output.get(new javax.xml.namespace.QName("",
								"addOutFileDirsReturn")),
								grms_pkg.GrmsResponse.class);
			}
	...
	public void deleteOutFileDirs(java.lang.String jobId,
		...
		if (_resp instanceof java.rmi.RemoteException) {
			...
			try {
				deleteOutFileDirsReturn.value = (grms_pkg.GrmsResponse) _output
						.get(new javax.xml.namespace.QName("",
								"deleteOutFileDirsReturn"));
			} catch (java.lang.Exception _exception) {
				deleteOutFileDirsReturn.value = (grms_pkg.GrmsResponse) org.apache.axis.utils.JavaUtils
						.convert(_output.get(new javax.xml.namespace.QName("",
								"deleteOutFileDirsReturn")),
								grms_pkg.GrmsResponse.class);
			}
