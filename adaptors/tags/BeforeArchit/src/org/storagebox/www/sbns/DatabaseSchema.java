...
public class DatabaseSchema implements java.io.Serializable {
	private org.storagebox.www.sbns.DatabaseAttributeSchema[] item;

	public DatabaseSchema() {
	}

	public org.storagebox.www.sbns.DatabaseAttributeSchema[] getItem() {
		return item;
	}

	public void setItem(org.storagebox.www.sbns.DatabaseAttributeSchema[] item) {
		this.item = item;
	}

	public org.storagebox.www.sbns.DatabaseAttributeSchema getItem(int i) {
		return item[i];
	}

	public void setItem(int i,
			org.storagebox.www.sbns.DatabaseAttributeSchema value) {
		this.item[i] = value;
	}
