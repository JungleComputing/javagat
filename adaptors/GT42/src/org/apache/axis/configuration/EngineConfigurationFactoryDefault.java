    ...
    implements EngineConfigurationFactory
{
    ...
    /*I changed the value of this field, so it will look for the right 
      configuration file. The Old value is the commented one*/
    public static final String OPTION_CLIENT_CONFIG_FILE = "axis.ClientConfigFileGT42";
    ...
    /*I changed the value of this field, so it will look for the right 
    wsdd file.The Old value is the commented one */
    protected static final String CLIENT_CONFIG_FILE = "client-configGT42.wsdd";
