...
public class GliteResourceBrokerAdaptor extends ResourceBrokerCpi {
	...
	public Job submitJob(AbstractJobDescription jobDescription, MetricListener listener, String metricDefinitionName )
			throws GATInvocationException {
		
		GliteJob job = new GliteJob(context, (JobDescription) jobDescription, null, brokerURI.toString());
