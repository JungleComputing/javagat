 ...
 * Schema.
 * $Id: Arguments.java,v 1.9 2006/01/23 11:05:53 rob Exp $
 */
package grms_schema;
...
public class Arguments implements java.io.Serializable {
     ...
     * @param vArgumentsItem
     */
    public void addArgumentsItem(int index,
            grms_schema.ArgumentsItem vArgumentsItem)
            throws java.lang.IndexOutOfBoundsException {
     ...
     * @param vArgumentsItem
     */
    public void setArgumentsItem(int index,
            grms_schema.ArgumentsItem vArgumentsItem)
            throws java.lang.IndexOutOfBoundsException {
        //-- check bounds for index
        if ((index < 0) || (index > _items.size())) {
