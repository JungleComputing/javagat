...
public class ProActiveLauncher implements Serializable, InitActive, RunActive {
    ...
    public void runActivity(Body body) {
        ...
        System.out.println("runActivity terminates");
    }
    ...
    public String launch(String classname, String jvmArgs, String progArgs,
            String classpath, Node node) {
    ...
    public int getExitStatus(String id) {
        synchronized(watchers) {
