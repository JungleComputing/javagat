...
public class LocalQResourceBrokerAdaptor extends ResourceBrokerCpi implements
    ...
    protected static Logger logger =
        Logger.getLogger(LocalQResourceBrokerAdaptor.class);
    ...
    public Job submitJob(JobDescription description, MetricListener listener,
        ...
        Sandbox sandbox =
            new Sandbox(gatContext, preferences, description, "localhost",
                    home, true, true, true, true);

        LocalQJob result =
            new LocalQJob(gatContext, preferences, this, description, sandbox,
                    start);
