 ...
 * instance of the class CommandlineSshPrunResourceBrokerAdaptor with the appropriate
...
public class CommandlineSshPrunResourceBrokerAdaptor extends ResourceBrokerCpi {
    ...
    public Job submitJob(JobDescription description)
        ...
        try {
            ...
            System.out.println("SshPrunResourceAdaptor: failed to retrieve credentials"
                + e);
        }
        ...
        if (windows) {
            command = "sexec " + sui.username + "@" + host + " -unat=yes -cmd="
                + "/home/rob/bin/do_prun " + path + " " + getArguments(description);
