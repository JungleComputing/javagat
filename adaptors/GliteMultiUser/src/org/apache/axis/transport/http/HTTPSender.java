...
import org.gridlab.gat.io.cpi.gliteMultiUser.srm.HttpgURLStreamHandlerFactory;


/**
 * The class was changed to support httpg protocol in some J2EE container like tomcat
 * The only method changed is  public void invoke(MessageContext msgContext) throws AxisFault
 * it is extended in compare to the original one by check if url string contains httpg
 * and then java URL object is created from url string using HttpgURLStreamHandlerFactory
 * provided in this SRM project
 *
