...
class SteeringMasterRMI extends Thread
{
	SteeringManager sm;
	String steeredHostname;

	public SteeringMasterRMI(SteeringManager sm, String steeredHostname)
	{
		this.sm = sm;
		this.steeredHostname = steeredHostname;
	}
	...
	public void run()
	{
			...
			if(!steerables.contains("//"+steeredHostname+":20000/MY_STEERABLE_COMPONENT"))
			{
				System.out.println("MASTER: Steerable object //"+steeredHostname+":20000/MY_STEERABLE_COMPONENT not found. Exiting ...");
				System.exit(1);
			}
			...
			controls = sm.getControlDefinitions("//"+steeredHostname+":20000/MY_STEERABLE_COMPONENT");
		...
		*/
			...
			System.out.println("MASTER: Sending command to start simulation at //"+steeredHostname+":20000/MY_STEERABLE_COMPONENT ...");	
			sm.executeControl("//"+steeredHostname+":20000/MY_STEERABLE_COMPONENT", new SteeringControl(startDefinition, null));
			...
			for(int i = 0; i < 10; i++)
			{
				...
				System.out.println("MASTER: Sending command MY_STEERED_INT_1 = " + i + " to //"+steeredHostname+":20000/MY_STEERABLE_COMPONENT ...");	
				sm.executeControl("//"+steeredHostname+":20000/MY_STEERABLE_COMPONENT", new SteeringControl(setIntDefinition, actualParameters1));
				System.out.println("MASTER: Command successfully sent.");	
				...
				System.out.println("MASTER: Sending command MY_STEERED_INT_2 = " + 2*i + " to //"+steeredHostname+":20000/MY_STEERABLE_COMPONENT ...");	
				sm.executeControl("//"+steeredHostname+":20000/MY_STEERABLE_COMPONENT", new SteeringControl(setIntDefinition, actualParameters2));
				System.out.println("MASTER: Command successfully sent.");	
				...
				System.out.println("MASTER: Sending command MY_STEERED_DOUBLE = " + 10.0/i + " to //"+steeredHostname+":20000/MY_STEERABLE_COMPONENT ...");	
				sm.executeControl("//"+steeredHostname+":20000/MY_STEERABLE_COMPONENT", new SteeringControl(setDoubleDefinition, actualParameters3));
				System.out.println("MASTER: Command successfully sent.");	
			}
			...
			System.out.println("MASTER: Sending command to stop simulation at //"+steeredHostname+":20000/MY_STEERABLE_COMPONENT ...");	
			sm.executeControl("//"+steeredHostname+":20000/MY_STEERABLE_COMPONENT", new SteeringControl(stopDefinition, null));
			System.out.println("MASTER: Command successfully sent.");	
		}
		catch(Exception e)
		{
