 ...
 * Currently this class is a place holder for the user preferences, the
 * structure of which is in development.
 */
public class Preferences extends Hashtable {
	...
	public Object put(Object key, Object value) {
		/*
		 * Note: This uglyness is required as Attributes keys are
		 * Attributes.Name instances and not String instances. ( An
		 * Attributes.Name class is only a wrapper around a String used as the
		 * keys in Attributes instances are case insensitive and can contain
		 * only certain letters. ) Attributes's values are String instances.
		 */
