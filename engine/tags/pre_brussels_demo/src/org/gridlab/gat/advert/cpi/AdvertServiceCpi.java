...
public class AdvertServiceCpi implements AdvertService, Monitorable {
	 ...
	 */
	public void delete(String path) throws GATInvocationException, NoSuchElementException {
		throw new Error("Not implemented");
	}
	 ...
	 *             The path is incorrect.
	 */
	public MetaData getMetaData(String path) throws GATInvocationException, NoSuchElementException {
		throw new Error("Not implemented");
	}
	...
	protected void checkName(String adaptor) throws AdaptorCreationException {
		String name = (String) preferences.get("advert.adaptor.name");
