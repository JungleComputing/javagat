...
public class HardwareResourceDescription implements ResourceDescription {
	...
	public HardwareResourceDescription(Map hardwareResourceDescription) {
		this.hardwareResourceDescription = new Hashtable(hardwareResourceDescription);
	}
	 ...
	 *            hardware component.
	 * @throws NoSuchElementException when the element that has to be remove cannot be found
	 */
