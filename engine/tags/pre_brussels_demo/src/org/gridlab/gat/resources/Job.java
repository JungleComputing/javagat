...
public abstract class Job implements Monitorable, Advertisable {
	 ...
	 */
	public abstract void unSchedule() throws GATInvocationException,
			IOException;
	 ...
	 *             Upon non-remote IO problem
	 */
	public abstract void stop() throws GATInvocationException, 
			IOException;
	 ...
	 *
	 * @param resource HarwareResource to run the job on (null means any resource)
	 * @return the clone of the job
	 */
	public abstract Job cloneJob(HardwareResource resource);
