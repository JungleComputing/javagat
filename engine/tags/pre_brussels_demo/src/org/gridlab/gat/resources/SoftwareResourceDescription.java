...
public class SoftwareResourceDescription implements ResourceDescription {
	...
	public SoftwareResourceDescription(Map softwareResourceDescription,
		...
		this.softwareResourceDescription = new HashMap(softwareResourceDescription);
	 ...
	 *            The new java.util.Map, the SoftwareResourceDescription associated
	 *            with this instance
	 */
	 ...
	 * @throws NoSuchElementException the element to be removed cannot be found
	 */
