...
import org.gridlab.gat.resources.software.SoftwareResourceDescription;
 ...
 * which describe a hardware resource.</li>
 * <li> A java.util.List of SoftwareResourceDescription instances each of which 
 * describes a software resource upon which the parent hardware resource depends.</li>
 * <i> A java.util.List of HardwareResourceDescription instances each of which 
 * describes a hardware resource upon which the parent hardware resource depends.</li>
 * </ul>
 ...
 * <TH>Description
 * <TBODY>
 * <TR><TD>memory.size<TD>java.lang.Float<TD>The minimum memory in GB.
 * <TR><TD>memory.accesstime<TD>java.lang.Float<TD>The minimum memory access time in ns.
 * <TR><TD>memory.str<TD>java.lang.Float<TD>The minimum sustained transfer rate in GB/s.
 * <TR><TD>machine.type<TD>java.lang.String<TD>The machine type as returned from uname -m
 * <TR><TD>machine.node<TD>java.lang.String<TD>The machine node as returned from uname -n
 * <TR><TD>cpu.type<TD>java.lang.String<TD>The generic cpu type as returned from uname -p
 * <TR><TD>cpu.speed<TD>java.lang.Float<TD>The minimum cpu speed in GHz.
 * <TR><TD>disk.size<TD>java.lang.Float<TD>The minimum size of the hard drive in GB.
 * <TR><TD>disk.accesstime<TD>java.lang.Float<TD>The minimum disk access time in ms.
 * <TR><TD>disk.str<TD>java.lang.Float<TD>The minimum sustained transfer rate in MB/s.
 * <TBODY>
 * </TABLE>
 */
public class HardwareResourceDescription
{
    ...
    * each of which describes a software component upon which the "parent" hardware 
    * component depends.
    */
    ...
    * each of which describes a hardware component upon which the "parent" hardware 
    * component depends.
    */
    ...
    * <ul>
    * <li> <em>HardwareResourceDescription</em> --- A java.util.Map, which describes 
    * the "parent" hardware component. </li>
    ...
    */
    public boolean equals(Object object)
    {
        ...
        if(false == hardwareResourceDescription.equals(hResourceDescription.hardwareResourceDescription))
         return false;
        if(false == softwareResourceDescriptions.equals(hResourceDescription.softwareResourceDescriptions))
         return false;
        if(false == hardwareResourceDescriptions.equals(hResourceDescription.hardwareResourceDescriptions))
         return false;
    ...
    */
    public Map getHardwareResourceDescription()
    {
    ...
    *
    * @param hrd The HardwareResourceDescription of this instance
    */
    public void setHardwareResourceDescription(Map hrd)
    {
    ...
    * describe the "parent" hardware component.
    */
    public void addHardwareResourceAttribute(String name, Object value)
    {
    ...
    * from the  name/value pairs which describe the "parent" hardware component.
    */
    public void removeHardwareResourceAttribute( String name )
    {
