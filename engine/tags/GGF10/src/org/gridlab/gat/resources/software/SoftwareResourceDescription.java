 ...
 * described a SoftwareResourceDescription... However, a piece of
 ...
 * quantities:
 * <ul>
 * <li> A java.util.Map which contains a set of name/value pairs, detailed later, 
 * which describe a software resource.</li>
 * <li> A java.util.List of SoftwareResourceDescription instances each of which 
 * describes a software resource upon which the parent software resource depends.</li>
 * <li> A java.util.List of HardwareResourceDescription instances each of which 
 * describes a hardware resource upon which the parent software resource depends.</li>
 * </ul>
 * <p>
 ...
 *        frame="box" 
 *        rules="groups" 
 *        summary="Minimum set of supported name/value pairs">
 * <CAPTION>Minimum set of supported name/value pairs</CAPTION>
 * <COLGROUP align="left">
 ...
 * <TH>Description
 * <TBODY>
 * <TR><TD>software.location<TD>org.gridlab.gat.util.Location<TD>The software location.
 * <TR><TD>software.checkpointable<TD>java.lang.Boolean<TD>A boolean indicating if the software is checkpointable.
 * <TR><TD>software.arguments<TD>java.util.List<TD>The software arguments,elements are java.lang.String's.
 * <TR><TD>software.environment<TD>java.util.Map<TD>The software environment, names/values are java.lang.String's.
 * <TR><TD>software.stdin<TD>org.gridlab.gat.io.File<TD>The software stdin.
 * <TR><TD>software.stdout<TD>org.gridlab.gat.util.Location<TD>The software stdout.
 * <TR><TD>software.stderr<TD>org.gridlab.gat.util.Location<TD>The software stderr.
 * <TR><TD>os.name<TD>java.lang.String<TD>The os name  as returned from uname -s
 * <TR><TD>os.type<TD>java.lang.String<TD>The os type  as returned from uname -p
 * <TR><TD>os.version<TD>java.lang.String<TD>The os version  as returned from uname -v
 * <TR><TD>os.release<TD>java.lang.String<TD>The os release  as returned from uname -r
 * <TR><TD>os.name<TD>java.lang.String<TD>The os name  as returned from uname -s
 * <TBODY>
 * </TABLE>
 */
public class SoftwareResourceDescription
{
   ...
   /**
    * This member variable holds a List of SoftwareResourceDescription's describing 
    * each of which describes a software component upon which the "parent" software 
    * component depends.
    */
    private List softwareResourceDescriptions = null;
    
   /**
    * This member variable holds a List of HardwareResourceDescription's describing 
    * each of which describes a hardware component upon which the "parent" software 
    * component depends.
    */
    ...
    * <ul>
    * <li> <em>SoftwareResourceDescription</em> --- A java.util.Map, which describes 
    * the "parent" software component. </li>
    * <li> <em>SoftwareResourceDescriptions</em> --- A java.util.List, which is a 
    * list of SoftwareResourceDescriptions each of which describes a software component
    * upon which the "parent" software component depends.</li>
    * <li> <em>HardwareResourceDescriptions</li> --- A java.util.List, which is a list 
    ...
    */
    public boolean equals(Object object)
    {
        ...
        if(false == softwareResourceDescription.equals(sResourceDescription.softwareResourceDescription))
         return false;
        if(false == softwareResourceDescriptions.equals(sResourceDescription.softwareResourceDescriptions))
         return false;
        if(false == hardwareResourceDescriptions.equals(sResourceDescription.hardwareResourceDescriptions))
         return false;
    ...
    *
    * @return A java.util.Map, the SoftwareResourceDescription associated with this instance
    */
    public Map getSoftwareResourceDescription()
    {
    ...
    *
    * @param The new java.util.Map, the SoftwareResourceDescription associated with this instance
    */
    public void setSoftwareResourceDescription(Map softwareResourceDescription)
    {
        this.softwareResourceDescription  = softwareResourceDescription;
    }
    ...
    *
    * @param name The Name, a java.lang.String, to add to the  name/value pairs 
    * which describe the "parent" software component.
    * @param value The Value, an Object, to add to the  name/value pairs which 
    * describe the "parent" software component.
    */
    public void addSoftwareResourceAttribute(String name, Object value)
    {
    ...
    *
    * @param name The Name, a java.lang.String, to of the name/value pair to remove 
    * from the  name/value pairs which describe the "parent" software component.
    */
    public void removeSoftwareResourceAttribute( String name )
    {
    ...
    *
    * @param hardwareResourceDescription The HardwareResourceDescription to add to 
    * the java.util.List of HardwareResourceDescriptions which describe this 
    * SoftwareResourceDescription.
    */
    public void addHardwareResourceDescription(HardwareResourceDescription hardwareResourceDescription)
    {
    ...
    *  SoftwareResourceDescription.
    *
    * @param hardwareResourceDescription The HardwareResourceDescription to remove 
    * from the java.util.List of HardwareResourceDescriptions which describe this 
    * SoftwareResourceDescription.
    */
    public void removeHardwareResourceDescription(HardwareResourceDescription hardwareResourceDescription)
    {
    ...
    *
    * @param hardwareResourceDescriptions The new java.util.List of 
    * HardwareResourceDescriptions which describe this 
    * SoftwareResourceDescription.
    */
    public void setHardwareResourceDescriptions(List hardwareResourceDescriptions)
    {
        this.hardwareResourceDescriptions = hardwareResourceDescriptions;
    }
    ...
    *  SoftwareResourceDescription.
    *
    * @return The java.util.List of HardwareResourceDescriptions which describe this 
    * SoftwareResourceDescription.
    */
    ...
    *
    * @param softwareResourceDescription The SoftwareResourceDescription to add to 
    * the java.util.List of SoftwareResourceDescriptions which describe this 
    * SoftwareResourceDescription.
    */
    public void addSoftwareResourceDescription(SoftwareResourceDescription softwareResourceDescription)
    {
    ...
    *  SoftwareResourceDescription.
    *
    * @param softwareResourceDescription The SoftwareResourceDescription to remove 
    * from the java.util.List of SoftwareResourceDescriptions which describe this 
    * SoftwareResourceDescription.
    */
    public void removeSoftwareResourceDescription(SoftwareResourceDescription softwareResourceDescription)
    {
    ...
    *  SoftwareResourceDescription to the passed java.util.List.
    *
    * @param softwareResourceDescriptions The new java.util.List of 
    * SoftwareResourceDescriptions which describe this 
    * SoftwareResourceDescription.
    */
    public void setSoftwareResourceDescriptions(List softwareResourceDescriptions)
    {
        this.softwareResourceDescriptions = softwareResourceDescriptions;
    }
    
   /**
    *  Gets the java.util.List of SoftwareResourceDescriptions which describe this
    *  SoftwareResourceDescription.
    *
    * @return The java.util.List of SoftwareResourceDescriptions which describe this 
    * SoftwareResourceDescription.
    */
