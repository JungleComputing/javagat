...
public class TimePeriod
{
    ...
    *
    * @param startTime The number of milliseconds after January 1, 1970, 
    * 00:00:00 GMT when the time period starts, a long
    * @param stopTime The number of milliseconds after January 1, 1970, 
    ...
    * 00:00:00 GMT when the time period starts, a long 
    *
    * @return The number of milliseconds after January 1, 1970, 00:00:00 
