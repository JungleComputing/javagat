...
/**
 * Interface which is to be implemented by any classes which are capable of being 
 * monitored.
 */
public interface Monitorable
{
   /**
    * This method adds the passed instance of a MetricListener to the list
    ...
    * @throws java.rmi.RemoteException Thrown upon problems accessing the remote 
    * instance 
    */
    ...
    * @param metricListener The MetricListener to notify of MetricEvents
    * @param metric The Metric corresponding to the MetricEvents for which the passed 
    * MetricListener has been notified
    * @throws java.rmi.RemoteException Thrown upon problems accessing the remote 
    * instance
    */
    ...
    *
    * @return An java.util.List of Metric instances. Each Metric instance in this 
    * java.util.List is a Metric which can be monitored on this instance
    * @throws java.rmi.RemoteException Thrown upon problems accessing the remote 
    * instance
    */
