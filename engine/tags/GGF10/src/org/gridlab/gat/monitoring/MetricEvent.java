 ...
 * <p>
 * A metric event occurs whenever the monitored resource, be it a job or a hardware 
 * resource, sends out an event to the monitoring system. This can encompass almost 
 * any type of event from disk space running out to memory becoming  available. The 
 * various events are defined by the various sensors. This topic is covered in more 
 * detail in the Metric documentation.
 */
public class MetricEvent extends EventObject
{
    ...
    *
    * @param source The source of the MetricEvent
    * @param value The value of the MetricEvent
    * @param metric The Metric of the MetricEvent
    * @param eventTime The number of milliseconds after January 1, 1970, 00:00:00 GMT 
