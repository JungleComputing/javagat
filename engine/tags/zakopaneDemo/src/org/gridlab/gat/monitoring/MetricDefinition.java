 ...
 * use the measurement frequency information to optimise measurements.
 * <p>
...
public class MetricDefinition implements Serializable {
    ...
    public MetricDefinition(String metricName, int measurementType,
            String dataType, String unit, Map parameterDefinitions, Map returnDefinition) {
    ...
    public String toString() {
        ...
        res += ", datatype = " + dataType + ", unit = " + unit
