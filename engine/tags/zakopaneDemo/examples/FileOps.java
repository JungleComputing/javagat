...
/**********************************************************
 * This program demonstrates the usage of the GATFile object.
 * It creates such an object, and performs all types of operations
 * on it: create file, copy, delete, .
 **********************************************************/
...
public class FileOps {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 3) {
            System.out.println("\tUsage: run_gat_app examples.FileOps <file1> <file2> <file3>\n\n" +
                               "\tprogram does:\n" +
                               "\t\tcp <file1> <file2>\n" +
                               "\t\trm <file1>\n" +
                               "\t\tmv <file2> <file3>\n");
