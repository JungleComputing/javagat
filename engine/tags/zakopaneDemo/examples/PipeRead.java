...
/**********************************************************
 * This programs creates an GAT Endpoint, advertises it to
 * the advert service, and listens for incomming
...
public class PipeRead {
	...
	try {
	    ...
	    // Because this program is the creator of the Endpoint, use 'listen'.
