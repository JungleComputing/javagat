...
/**********************************************************
 * This programs gets an GAT Endpoint out of the advert
 * service, connects to it, and writes a message to the
 * obtained GAT Pipe.
 **********************************************************/
...
public class PipeWrite {
	...
	try {
	    ...
	    // Just to check (as there should only be one path), print the number
	    ...
	    // That path should be "/home/mjfdreus/endpoint" (see PipeRead.java).
