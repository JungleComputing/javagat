...
/**********************************************************
 * This program demonstrates the usage of the GAT
 * FileOutputStream.
 * It creates such an stream and the file as well, and write
 * some data to it.
 **********************************************************/
...
public class FileStreamSimple {
    ...
    public static void main(String[] args) {
        ...
        if (args.length != 1) {
            System.out.println("\tUsage: run_gat_app examples.FileStreamSimple <file>\n" +
