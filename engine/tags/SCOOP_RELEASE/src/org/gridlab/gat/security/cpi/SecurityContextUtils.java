...
public class SecurityContextUtils {
    ...
    public static List getValidSecurityContexts(GATContext context,
        ...
        return getValidSecurityContextsByType(context, preferences, null /* no type*/, adaptorName, host, port);
    }
    ...
    public static List getValidSecurityContextsByType(GATContext context,
            Preferences preferences, String type, String adaptorName, String host, int port) {
