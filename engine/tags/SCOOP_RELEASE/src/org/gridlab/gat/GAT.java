...
public class GAT {
	 ...
	 */
	public static LogicalFile createLogicalFile(GATContext gatContext, String name, int mode)
			throws GATObjectCreationException {
	...
	public static File createFile(GATContext gatContext,
		...
		File f = (File) getAdaptorProxy(FileCpi.class,
				File.class, gatContext, preferences, array);
