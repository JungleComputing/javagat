...
public class HardwareResourceDescription implements ResourceDescription {
	 ...
	 * component
	 */
	private Hashtable hardwareResourceDescription = null;
	...
	public HardwareResourceDescription(Map hardwareResourceDescription) {
		this.hardwareResourceDescription = new Hashtable(
	...
	public int hashCode() {
		return hardwareResourceDescription.hashCode();
	}
	...
	public void setDescription(Map hrd) {
		hardwareResourceDescription = new Hashtable(hrd);
	}
	 ...
	 *             when the element that has to be remove cannot be found
	 */
	 ...
	 * HardwareResourceDescription.
	 * 
	 * @param newHardwareResourceDescription
	...
	public void addResourceDescription(
			ResourceDescription newHardwareResourceDescription) {
		hardwareResourceDescriptions.add(newHardwareResourceDescription);
	}
	 ...
	 * HardwareResourceDescription.
	 * 
	 * @param oldHardwareResourceDescription
	...
	public void removeResourceDescription(
			ResourceDescription oldHardwareResourceDescription) {
		hardwareResourceDescriptions.remove(oldHardwareResourceDescription);
	}
