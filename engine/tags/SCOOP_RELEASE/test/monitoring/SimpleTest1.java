...
public class SimpleTest1
{
	public static void main(String[] args)
	{
                ...
                try
		    {
				...
				System.out.println("metricDefinitions.size() = " + metricDefinitions.size());
				...
				try
				{
					System.out.println("Metric "+((MetricDefinition) metricDefinitions.get(i)).getMetricName()+": "+m.getMeasurement(new Metric((MetricDefinition) metricDefinitions.get(i), params, 0)).getValue());
				}
		                    catch(Exception e)
                	    	{
                        		e.printStackTrace();
