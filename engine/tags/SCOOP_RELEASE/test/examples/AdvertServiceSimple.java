...
public class AdvertServiceSimple {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            /*
             * This doesn't seem to work. It returns with some "Not implemented"
             * errors. // Create AdvertService object. advert =
             * GAT.createAdvertService(context);
             *  // Create the object to be published. src = new URI(uri); file =
             * GAT.createFile(context, src);
             *  // Create MetaData object and fill it with a key-value pair.
             * meta = new MetaData(); meta.put(key, value);
             *  // Publish the object to the advert service. advert.add(file,
             * meta, path);
             *  
             */
