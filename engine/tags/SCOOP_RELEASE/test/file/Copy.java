...
class Copy {
	...
	public static void main(String[] args) {
		...
		try {
			src = new URI("/home/rob/contrib/eclipse/workspace/JavaGATEngine/test/file/test_input.dat");
			dest = new URI("/home/rob/contrib/eclipse/workspace/JavaGATEngine/test/file/test_input_copy.dat");
